...
// Clerk appearance tokens mapped to the CampusVault dark/metal design system.
...
export function LoginPage() {
  return (
    <div className="relative min-h-screen overflow-y-auto overflow-x-hidden grain preserve-3d flex flex-col lg:flex-row items-center lg:items-stretch justify-center">
      ...
      <div className="bg-lettering opacity-[0.02]">LOGIN</div>
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, rgba(245,158,11,0.10), transparent 60%)', filter: 'blur(70px)' }}
      />
